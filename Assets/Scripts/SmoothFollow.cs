...
public class SmoothFollow : MonoBehaviour
{
    ...
    private void Update()
    {
        float carSpeed = target[index].parent.gameObject.GetComponent<Drive>().currentSpeed;
        speedText.text = carSpeed.ToString("F0");
        speedometer.SpeedNeedleRotation(carSpeed);
